...
The fork has all the necessary meta tags for posts. Forum maps for adding to search engines, for better indexing and SEO in general. Tested with latest versions of PHP 8+, MySQL 8+ and WordPress 6.7.+ The forum advertising system has been restored.
